...
public class Assignment2_65050581_65050777 extends JPanel implements Runnable {
    ...
    private BufferedImage drawStrawHatStyle1() {
        ...
        drawArc(g, new Point(449, 317), new Point(452, 313), new Point(458, 306), new Point(454, 304), 1,
            MyColor.BLACK);
        drawArc(g, new Point(180, 336), new Point(118, 347), new Point(14, 342), new Point(14, 368), 1,
            MyColor.BLACK);
        drawArc(g, new Point(14, 368), new Point(47, 407), new Point(536, 427), new Point(576, 383), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawStrawHatStyle2() {
        ...
        drawArc(g, new Point(43, 398), new Point(38, 395), new Point(25, 389), new Point(17, 388), 1,
            MyColor.BLACK);
        drawArc(g, new Point(17, 388), new Point(14, 390), new Point(8, 400), new Point(13, 409), 1,
            MyColor.BLACK);
        drawArc(g, new Point(13, 409), new Point(17, 411), new Point(27, 416), new Point(31, 425), 1,
            MyColor.BLACK);
        drawArc(g, new Point(31, 425), new Point(73, 449), new Point(342, 524), new Point(492, 494), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawStrawHatStyle3() {
        ...
        drawArc(g, new Point(185, 329), new Point(140, 146), new Point(441, 84), new Point(426, 323), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(434, 339), new Point(434, 335), new Point(434, 326), new Point(426, 323), 1,
            MyColor.BLACK);
        drawArc(g, new Point(176, 346), new Point(138, 346), new Point(101, 366), new Point(91, 366), 1,
            MyColor.BLACK);
        drawArc(g, new Point(91, 366), new Point(70, 369), new Point(25, 370), new Point(25, 374), 1,
            MyColor.BLACK);
        drawArc(g, new Point(25, 374), new Point(15, 376), new Point(1, 393), new Point(25, 408), 1,
            MyColor.BLACK);
        drawArc(g, new Point(25, 408), new Point(99, 441), new Point(312, 454), new Point(418, 432), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawStrawHatStyle4() {
        ...
        drawArc(g, new Point(164, 349), new Point(81, 208), new Point(386, 27), new Point(452, 273), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(36, 427), new Point(27, 428), new Point(10, 432), new Point(10, 437), 1,
            MyColor.BLACK);
        drawArc(g, new Point(10, 437), new Point(8, 441), new Point(9, 449), new Point(19, 449), 1,
            MyColor.BLACK);
        g.drawLine(19, 449, 26, 445);
        g.drawLine(26, 445, 36, 445);
        g.drawLine(36, 445, 50, 444);
        g.drawLine(50, 444, 78, 435);
        drawArc(g, new Point(78, 435), new Point(121, 432), new Point(177, 412), new Point(229, 412), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(36, 445), new Point(48, 451), new Point(80, 451), new Point(100, 442), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawStrawHatStyle5() {
        ...
        drawArc(g, new Point(167, 300), new Point(192, 326), new Point(353, 349), new Point(449, 320), 1,
            MyColor.BLACK);
        drawArc(g, new Point(167, 300), new Point(134, 131), new Point(466, 62), new Point(449, 320), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(453, 341), new Point(453, 334), new Point(454, 320), new Point(449, 314), 1,
            MyColor.BLACK);
        drawArc(g, new Point(157, 320), new Point(110, 324), new Point(7, 343), new Point(19, 367), 1,
            MyColor.BLACK);
        drawArc(g, new Point(19, 367), new Point(35, 384), new Point(166, 413), new Point(200, 418), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawLuffyBoy() {
        ...
        // Face
        drawArc(g, new Point(160, 282), new Point(173, 84), new Point(446, 87), new Point(446, 288), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(221, 370), new Point(229, 372), new Point(255, 371), new Point(263, 355), 1,
            MyColor.BLACK);
        drawArc(g, new Point(193, 330), new Point(192, 334), new Point(191, 345), new Point(196, 354), 1,
            Color.WHITE); // **
        drawArc(g, new Point(264, 330), new Point(265, 334), new Point(266, 345), new Point(263, 355), 1,
            Color.WHITE); // **
        ...
        drawArc(g, new Point(360, 358), new Point(361, 369), new Point(408, 383), new Point(425, 351), 1,
            MyColor.BLACK);
        drawArc(g, new Point(357, 331), new Point(356, 334), new Point(355, 346), new Point(360, 359), 1,
            Color.WHITE); // **
        drawArc(g, new Point(428, 328), new Point(428, 333), new Point(429, 345), new Point(425, 351), 1,
            Color.WHITE); // **
        ...
        drawArc(g, new Point(100, 280), new Point(101, 284), new Point(100, 298), new Point(86, 320), 1,
            MyColor.BLACK);
        drawArc(g, new Point(86, 320), new Point(92, 316), new Point(103, 306), new Point(107, 300), 1,
            MyColor.BLACK);
        ...
        drawArc(g, new Point(175, 520), new Point(171, 526), new Point(159, 539), new Point(157, 542), 1,
            MyColor.BLACK);
        drawArc(g, new Point(160, 538), new Point(141, 547), new Point(98, 567), new Point(88, 568), 1,
            MyColor.BLACK);
        g.drawLine(88, 568, 77, 568);
        drawArc(g, new Point(77, 568), new Point(75, 570), new Point(72, 580), new Point(70, 599), 1,
            MyColor.BLACK);
        drawArc(g, new Point(73, 580), new Point(58, 583), new Point(20, 590), new Point(13, 600), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawLuffyChild() {
        ...
        drawArc(g, new Point(233, 287), new Point(237, 291), new Point(257, 295), new Point(269, 283), 1,
            MyColor.BLACK);
        drawArc(g, new Point(269, 283), new Point(272, 281), new Point(277, 265), new Point(269, 256), 1,
            Color.WHITE); // **
        drawArc(g, new Point(233, 287), new Point(226, 280), new Point(227, 268), new Point(228, 264), 1,
            Color.WHITE); // **
        ...
        drawArc(g, new Point(119, 222), new Point(182, 232), new Point(386, 217), new Point(414, 212), 1,
            MyColor.BLACK);
        drawArc(g, new Point(119, 222), new Point(119, 228), new Point(115, 244), new Point(99, 255), 1,
            MyColor.BLACK);
        drawArc(g, new Point(99, 255), new Point(105, 252), new Point(120, 243), new Point(131, 230), 1,
            MyColor.BLACK);
    ...
    private BufferedImage drawLogoOnePiece() {
        ...
        drawArc(g, new Point(68, 239), new Point(64, 241), new Point(55, 243), new Point(54, 233), 1,
            Color.BLACK);
        drawArc(g, new Point(54, 233), new Point(54, 230), new Point(57, 224), new Point(63, 226), 1,
            Color.BLACK);
        drawArc(g, new Point(63, 226), new Point(63, 222), new Point(63, 215), new Point(73, 217), 1,
            Color.BLACK);
        drawArc(g, new Point(73, 217), new Point(78, 218), new Point(81, 224), new Point(76, 231), 1,
            Color.BLACK);
        g.drawLine(76, 231, 90, 245);
        g.drawLine(90, 245, 81, 252);
        g.drawLine(169, 245, 184, 231);
        drawArc(g, new Point(184, 231), new Point(182, 228), new Point(180, 222), new Point(185, 219), 1,
            Color.BLACK);
        drawArc(g, new Point(185, 219), new Point(188, 217), new Point(197, 217), new Point(197, 226), 1,
            Color.BLACK);
        drawArc(g, new Point(197, 226), new Point(201, 226), new Point(209, 228), new Point(204, 238), 1,
            Color.BLACK);
        drawArc(g, new Point(204, 238), new Point(203, 240), new Point(198, 244), new Point(192, 240), 1,
            Color.BLACK);
        g.drawLine(192, 240, 178, 254);
        g.drawLine(178, 254, 169, 245);
        g.drawLine(80, 334, 68, 346);
        drawArc(g, new Point(68, 346), new Point(65, 345), new Point(60, 343), new Point(56, 346), 1,
            Color.BLACK);
        drawArc(g, new Point(56, 346), new Point(53, 349), new Point(52, 359), new Point(62, 359), 1,
            Color.BLACK);
        drawArc(g, new Point(62, 359), new Point(63, 363), new Point(66, 371), new Point(74, 367), 1,
            Color.BLACK);
        drawArc(g, new Point(74, 367), new Point(76, 365), new Point(80, 361), new Point(76, 355), 1,
            Color.BLACK);
        g.drawLine(76, 355, 88, 343);
        g.drawLine(88, 343, 80, 334);
        g.drawLine(87, 296, 60, 292);
        drawArc(g, new Point(60, 292), new Point(65, 289), new Point(76, 285), new Point(90, 283), 1,
            Color.BLACK);
        g.drawLine(172, 296, 192, 293);
        drawArc(g, new Point(90, 283), new Point(110, 279), new Point(140, 278), new Point(169, 283), 1,
            Color.BLACK);
        drawArc(g, new Point(90, 283), new Point(90, 259), new Point(147, 229), new Point(169, 283), 1,
            Color.BLACK);
        drawArc(g, new Point(169, 283), new Point(179, 285), new Point(190, 288), new Point(200, 292), 1,
            Color.BLACK);
        g.drawLine(200, 292, 192, 293);
        drawArc(g, new Point(192, 293), new Point(193, 304), new Point(189, 330), new Point(162, 348), 1,
            Color.BLACK);
        drawArc(g, new Point(91, 275), new Point(105, 273), new Point(138, 269), new Point(166, 275), 1,
            Color.BLACK);
        drawArc(g, new Point(94, 288), new Point(110, 287), new Point(146, 285), new Point(165, 288), 1,
            Color.BLACK);
        drawArc(g, new Point(165, 288), new Point(168, 288), new Point(174, 291), new Point(171, 301), 1,
            Color.BLACK);
        drawArc(g, new Point(171, 301), new Point(167, 328), new Point(143, 336), new Point(131, 337), 1,
            Color.BLACK);
        drawArc(g, new Point(131, 337), new Point(101, 337), new Point(90, 314), new Point(88, 303), 1,
            Color.BLACK);
        drawArc(g, new Point(88, 303), new Point(84, 293), new Point(91, 289), new Point(94, 288), 1,
            Color.BLACK);
        g.drawLine(114, 334, 111, 338);
        g.drawLine(111, 338, 95, 351);
        g.drawLine(95, 351, 81, 363);
        g.drawLine(81, 363, 77, 363);
        drawArc(g, new Point(111, 338), new Point(115, 341), new Point(125, 344), new Point(138, 342), 1,
            Color.BLACK);
        g.drawLine(149, 339, 145, 333);
        drawArc(g, new Point(149, 339), new Point(159, 348), new Point(188, 367), new Point(212, 364), 1,
            Color.BLACK);
        drawArc(g, new Point(212, 364), new Point(212, 367), new Point(209, 370), new Point(208, 371), 1,
            Color.BLACK);
        drawArc(g, new Point(208, 371), new Point(200, 383), new Point(152, 354), new Point(138, 342), 1,
            Color.BLACK);
        drawArc(g, new Point(149, 339), new Point(145, 340), new Point(141, 341), new Point(138, 342), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(89, 368), new Point(89, 365), new Point(89, 359), new Point(88, 359), 1,
            Color.BLACK);
        drawArc(g, new Point(89, 357), new Point(90, 359), new Point(91, 363), new Point(91, 366), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(102, 356), new Point(102, 354), new Point(101, 351), new Point(100, 349), 1,
            Color.BLACK);
        g.drawLine(100, 349, 95, 352);
        g.drawLine(102, 347, 105, 345);
        drawArc(g, new Point(105, 345), new Point(106, 346), new Point(108, 348), new Point(108, 352), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(88, 373), new Point(94, 366), new Point(111, 350), new Point(125, 343), 1,
            Color.BLACK);
        g.drawLine(80, 365, 78, 367);
        drawArc(g, new Point(78, 367), new Point(78, 368), new Point(79, 372), new Point(79, 376), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(86, 377), new Point(86, 373), new Point(82, 367), new Point(80, 365), 1,
            Color.BLACK);
        drawArc(g, new Point(76, 368), new Point(77, 370), new Point(78, 374), new Point(77, 377), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(111, 340), new Point(112, 341), new Point(114, 344), new Point(114, 348), 1,
            Color.BLACK);
        g.drawLine(114, 348, 110, 351);
        drawArc(g, new Point(110, 351), new Point(109, 349), new Point(108, 345), new Point(106, 344), 1,
            Color.BLACK);
        g.drawLine(114, 341, 116, 347);
        g.drawLine(116, 347, 120, 344);
        g.drawLine(120, 344, 114, 341);
        drawArc(g, new Point(115, 349), new Point(118, 351), new Point(138, 353), new Point(146, 349), 1,
            Color.BLACK);
        drawArc(g, new Point(111, 352), new Point(114, 363), new Point(138, 371), new Point(150, 351), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(191, 371), new Point(192, 369), new Point(194, 367), new Point(195, 365), 1,
            Color.BLACK);
        g.drawLine(195, 365, 190, 363);
        drawArc(g, new Point(197, 365), new Point(196, 366), new Point(195, 369), new Point(193, 371), 1,
            Color.BLACK);
        g.drawLine(193, 371, 199, 373);
        g.drawLine(199, 373, 204, 365);
        g.drawLine(204, 365, 197, 365);
        g.drawLine(206, 365, 201, 373);
        drawArc(g, new Point(201, 373), new Point(203, 372), new Point(208, 371), new Point(210, 367), 1,
            Color.BLACK);
        g.drawLine(210, 367, 206, 365);
        drawArc(g, new Point(97, 348), new Point(88, 344), new Point(65, 323), new Point(67, 294), 1,
            Color.BLACK);
        drawArc(g, new Point(67, 289), new Point(68, 271), new Point(81, 234), new Point(129, 232), 1,
            Color.BLACK);
        drawArc(g, new Point(129, 232), new Point(149, 232), new Point(186, 244), new Point(191, 289), 1,
            Color.BLACK);
        g.drawLine(171, 342, 184, 355);
        g.drawLine(184, 355, 181, 358);
        g.drawLine(179, 333, 193, 345);
        drawArc(g, new Point(204, 350), new Point(205, 353), new Point(206, 360), new Point(197, 360), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(364, 255), new Point(365, 256), new Point(366, 257), new Point(363, 259), 1,
            Color.BLACK);
        drawArc(g, new Point(363, 259), new Point(341, 268), new Point(347, 290), new Point(355, 294), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(361, 273), new Point(355, 276), new Point(355, 286), new Point(361, 289), 1,
            Color.BLACK);
        g.drawLine(361, 289, 361, 273);
        g.drawLine(362, 342, 351, 346);
        drawArc(g, new Point(351, 346), new Point(348, 347), new Point(349, 352), new Point(352, 351), 1,
            Color.BLACK);
        g.drawLine(352, 351, 369, 345);
        g.drawLine(369, 345, 378, 351);
        drawArc(g, new Point(378, 351), new Point(381, 353), new Point(386, 351), new Point(384, 349), 1,
            Color.BLACK);
        g.drawLine(384, 349, 376, 342);
        drawArc(g, new Point(300, 236), new Point(300, 236), new Point(303, 238), new Point(306, 243), 1,
            Color.BLACK);
        g.drawLine(306, 243, 306, 342);
        drawArc(g, new Point(306, 342), new Point(305, 343), new Point(303, 347), new Point(300, 349), 1,
            Color.BLACK);
        g.drawLine(300, 349, 325, 349);
        drawArc(g, new Point(325, 349), new Point(322, 347), new Point(318, 343), new Point(319, 339), 1,
            Color.BLACK);
        g.drawLine(319, 339, 319, 318);
        drawArc(g, new Point(319, 318), new Point(326, 319), new Point(342, 318), new Point(345, 302), 1,
            Color.BLACK);
        g.drawLine(345, 302, 345, 251);
        drawArc(g, new Point(345, 251), new Point(343, 246), new Point(337, 236), new Point(326, 236), 1,
            Color.BLACK);
        g.drawLine(326, 236, 300, 236);
        g.drawLine(319, 248, 319, 307);
        drawArc(g, new Point(319, 307), new Point(323, 307), new Point(332, 306), new Point(333, 299), 1,
            Color.BLACK);
        g.drawLine(333, 299, 333, 255);
        drawArc(g, new Point(333, 255), new Point(331, 253), new Point(327, 248), new Point(319, 248), 1,
            Color.BLACK);
        g.drawLine(196, 241, 196, 290);
        drawArc(g, new Point(196, 293), new Point(196, 307), new Point(195, 339), new Point(193, 346), 1,
            Color.BLACK);
        drawArc(g, new Point(193, 346), new Point(193, 346), new Point(191, 348), new Point(188, 350), 1,
            Color.BLACK);
        g.drawLine(188, 350, 215, 350);
        drawArc(g, new Point(215, 350), new Point(213, 346), new Point(211, 334), new Point(214, 324), 1,
            Color.BLACK);
        g.drawLine(214, 324, 222, 350);
        g.drawLine(222, 350, 241, 350);
        g.drawLine(241, 350, 288, 350);
        g.drawLine(288, 350, 288, 327);
        drawArc(g, new Point(288, 327), new Point(284, 335), new Point(276, 336), new Point(273, 336), 1,
            Color.BLACK);
        drawArc(g, new Point(273, 336), new Point(265, 335), new Point(260, 327), new Point(259, 324), 1,
            Color.BLACK);
        g.drawLine(259, 324, 259, 295);
        drawArc(g, new Point(259, 295), new Point(268, 293), new Point(276, 301), new Point(279, 305), 1,
            Color.BLACK);
        g.drawLine(279, 305, 279, 278);
        drawArc(g, new Point(279, 278), new Point(273, 287), new Point(263, 288), new Point(259, 288), 1,
            Color.BLACK);
        g.drawLine(259, 288, 259, 262);
        g.drawLine(259, 262, 262, 255);
        drawArc(g, new Point(262, 255), new Point(270, 243), new Point(282, 250), new Point(288, 255), 1,
            Color.BLACK);
        g.drawLine(288, 255, 287, 237);
        g.drawLine(287, 237, 241, 237);
        drawArc(g, new Point(241, 350), new Point(240, 349), new Point(240, 349), new Point(239, 348), 1,
            Color.BLACK);
        drawArc(g, new Point(241, 237), new Point(235, 241), new Point(236, 306), new Point(237, 338), 1,
            Color.BLACK);
        drawArc(g, new Point(237, 338), new Point(237, 342), new Point(238, 345), new Point(239, 348), 1,
            Color.BLACK);
        g.drawLine(241, 237, 219, 237);
        drawArc(g, new Point(219, 237), new Point(220, 243), new Point(220, 256), new Point(218, 260), 1,
            Color.BLACK);
        drawArc(g, new Point(218, 260), new Point(216, 255), new Point(214, 243), new Point(214, 237), 1,
            Color.BLACK);
        g.drawLine(214, 237, 205, 237);
        drawArc(g, new Point(241, 237), new Point(242, 238), new Point(244, 241), new Point(245, 245), 1,
            Color.BLACK);
        g.drawLine(245, 245, 245, 340);
        drawArc(g, new Point(245, 340), new Point(245, 341), new Point(244, 344), new Point(239, 348), 1,
            Color.BLACK);
        g.drawLine(383, 236, 434, 235);
        g.drawLine(434, 235, 434, 256);
        drawArc(g, new Point(434, 256), new Point(419, 240), new Point(408, 253), new Point(405, 260), 1,
            Color.BLACK);
        g.drawLine(405, 260, 405, 288);
        drawArc(g, new Point(405, 288), new Point(413, 290), new Point(421, 284), new Point(424, 281), 1,
            Color.BLACK);
        g.drawLine(424, 281, 424, 304);
        drawArc(g, new Point(424, 304), new Point(419, 296), new Point(410, 294), new Point(405, 294), 1,
            Color.BLACK);
        g.drawLine(405, 294, 405, 321);
        drawArc(g, new Point(405, 321), new Point(405, 333), new Point(415, 336), new Point(420, 336), 1,
            Color.BLACK);
        drawArc(g, new Point(420, 336), new Point(427, 335), new Point(431, 332), new Point(433, 330), 1,
            Color.BLACK);
        g.drawLine(433, 330, 433, 349);
        g.drawLine(433, 349, 385, 349);
        drawArc(g, new Point(385, 349), new Point(390, 345), new Point(391, 342), new Point(391, 340), 1,
            Color.BLACK);
        g.drawLine(391, 340, 391, 249);
        drawArc(g, new Point(391, 249), new Point(391, 243), new Point(386, 237), new Point(383, 236), 1,
            Color.BLACK);
        g.drawLine(464, 280, 482, 280);
        g.drawLine(482, 280, 482, 257);
        drawArc(g, new Point(482, 257), new Point(482, 250), new Point(476, 237), new Point(459, 237), 1,
            Color.BLACK);
        drawArc(g, new Point(459, 237), new Point(453, 236), new Point(440, 241), new Point(436, 257), 1,
            Color.BLACK);
        g.drawLine(436, 257, 436, 330);
        drawArc(g, new Point(436, 330), new Point(437, 336), new Point(443, 349), new Point(458, 350), 1,
            Color.BLACK);
        drawArc(g, new Point(458, 350), new Point(465, 351), new Point(479, 347), new Point(482, 331), 1,
            Color.BLACK);
        g.drawLine(482, 331, 482, 304);
        g.drawLine(482, 304, 463, 304);
        drawArc(g, new Point(463, 304), new Point(464, 304), new Point(466, 307), new Point(466, 312), 1,
            Color.BLACK);
        drawArc(g, new Point(466, 312), new Point(467, 317), new Point(465, 330), new Point(459, 329), 1,
            Color.BLACK);
        drawArc(g, new Point(459, 329), new Point(455, 329), new Point(452, 327), new Point(453, 318), 1,
            Color.BLACK);
        g.drawLine(453, 318, 453, 264);
        drawArc(g, new Point(453, 264), new Point(454, 261), new Point(455, 255), new Point(459, 256), 1,
            Color.BLACK);
        drawArc(g, new Point(459, 256), new Point(461, 256), new Point(465, 257), new Point(466, 263), 1,
            Color.BLACK);
        drawArc(g, new Point(466, 263), new Point(466, 266), new Point(466, 274), new Point(464, 280), 1,
            Color.BLACK);
        drawArc(g, new Point(513, 341), new Point(490, 330), new Point(484, 305), new Point(483, 294), 1,
            Color.BLACK);
        drawArc(g, new Point(483, 294), new Point(481, 258), new Point(512, 242), new Point(529, 238), 1,
            Color.BLACK);
        g.drawLine(529, 238, 527, 233);
        g.drawLine(527, 233, 541, 237);
        g.drawLine(541, 237, 532, 247);
        g.drawLine(532, 247, 530, 242);
        drawArc(g, new Point(530, 242), new Point(517, 247), new Point(496, 271), new Point(497, 288), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(520, 288), new Point(521, 285), new Point(524, 280), new Point(529, 280), 1,
            Color.BLACK);
        drawArc(g, new Point(529, 280), new Point(531, 279), new Point(537, 281), new Point(538, 290), 1,
            Color.BLACK);
        drawArc(g, new Point(538, 290), new Point(539, 294), new Point(538, 302), new Point(530, 303), 1,
            Color.BLACK);
        drawArc(g, new Point(530, 303), new Point(532, 298), new Point(536, 289), new Point(530, 287), 1,
            Color.BLACK);
        drawArc(g, new Point(530, 287), new Point(527, 286), new Point(522, 288), new Point(520, 296), 1,
            Color.BLACK);
        drawArc(g, new Point(520, 296), new Point(518, 301), new Point(514, 314), new Point(522, 320), 1,
            Color.BLACK);
        drawArc(g, new Point(522, 320), new Point(519, 330), new Point(510, 351), new Point(503, 355), 1,
            Color.BLACK);
        drawArc(g, new Point(503, 355), new Point(503, 355), new Point(460, 355), new Point(433, 355), 1,
            Color.BLACK);
        drawArc(g, new Point(503, 355), new Point(499, 359), new Point(496, 362), new Point(494, 363), 1,
            Color.BLACK);
        g.drawLine(433, 355, 426, 349);
        g.drawLine(433, 355, 445, 363);
        g.drawLine(494, 363, 445, 363);
        drawArc(g, new Point(494, 363), new Point(490, 368), new Point(477, 370), new Point(472, 371), 1,
            Color.BLACK);
        drawArc(g, new Point(472, 371), new Point(456, 370), new Point(447, 365), new Point(445, 363), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(497, 295), new Point(499, 308), new Point(506, 328), new Point(517, 334), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(524, 347), new Point(516, 360), new Point(496, 385), new Point(472, 384), 1,
            Color.BLACK);
        drawArc(g, new Point(472, 384), new Point(464, 384), new Point(445, 381), new Point(426, 365), 1,
            Color.BLACK);
        drawArc(g, new Point(426, 365), new Point(421, 362), new Point(411, 355), new Point(405, 355), 1,
            Color.BLACK);
        g.drawLine(544, 363, 511, 363);
        drawArc(g, new Point(532, 302), new Point(535, 305), new Point(541, 312), new Point(541, 318), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(533, 325), new Point(533, 328), new Point(531, 335), new Point(527, 342), 1,
            Color.BLACK);
        g.drawLine(73, 217, 544, 217);
        drawArc(g, new Point(544, 217), new Point(546, 218), new Point(549, 221), new Point(544, 225), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(366, 363), new Point(362, 362), new Point(357, 360), new Point(352, 355), 1,
            Color.BLACK);
        drawArc(g, new Point(381, 363), new Point(380, 367), new Point(377, 374), new Point(369, 375), 1,
            Color.BLACK);
        drawArc(g, new Point(369, 375), new Point(366, 375), new Point(358, 373), new Point(349, 366), 1,
            Color.BLACK);
        g.drawLine(349, 366, 333, 356);
        g.drawLine(333, 356, 326, 356);
        drawArc(g, new Point(326, 356), new Point(326, 353), new Point(328, 348), new Point(332, 348), 1,
            Color.BLACK);
        drawArc(g, new Point(332, 348), new Point(334, 347), new Point(341, 346), new Point(352, 354), 1,
            Color.BLACK);
        g.drawLine(344, 363, 301, 363);
        drawArc(g, new Point(270, 355), new Point(271, 359), new Point(278, 362), new Point(282, 363), 1,
            Color.BLACK);
        g.drawLine(282, 363, 301, 363);
        drawArc(g, new Point(301, 363), new Point(299, 367), new Point(295, 375), new Point(287, 375), 1,
            Color.BLACK);
        drawArc(g, new Point(287, 375), new Point(282, 376), new Point(259, 363), new Point(248, 356), 1,
            Color.BLACK);
        g.drawLine(248, 356, 205, 356);
        g.drawLine(253, 351, 248, 355);
        g.drawLine(248, 355, 243, 355);
        drawArc(g, new Point(243, 355), new Point(245, 353), new Point(250, 349), new Point(253, 351), 1,
            Color.BLACK);
        drawArc(g, new Point(410, 349), new Point(409, 350), new Point(406, 353), new Point(406, 355), 1,
            Color.BLACK);
        g.drawLine(326, 356, 270, 356);
        g.drawLine(270, 356, 260, 350);
        drawArc(g, new Point(244, 350), new Point(243, 351), new Point(240, 354), new Point(240, 356), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(298, 365), new Point(296, 369), new Point(291, 375), new Point(284, 373), 1,
            Color.BLACK);
        g.drawLine(284, 373, 290, 365);
        g.drawLine(336, 349, 333, 354);
        g.drawLine(333, 354, 328, 354);
        drawArc(g, new Point(328, 354), new Point(329, 352), new Point(332, 349), new Point(336, 349), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(367, 365), new Point(365, 367), new Point(363, 372), new Point(362, 372), 1,
            Color.BLACK);
        g.drawLine(362, 372, 367, 374);
        g.drawLine(367, 374, 372, 365);
        g.drawLine(372, 365, 367, 365);
        g.drawLine(374, 365, 369, 374);
        drawArc(g, new Point(369, 374), new Point(371, 373), new Point(377, 371), new Point(379, 365), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(539, 316), new Point(537, 317), new Point(533, 319), new Point(533, 318), 1,
            Color.BLACK);
        g.drawLine(531, 313, 532, 317);
        g.drawLine(532, 317, 539, 314);
        g.drawLine(539, 314, 536, 310);
        g.drawLine(536, 310, 531, 313);
        drawArc(g, new Point(528, 310), new Point(528, 310), new Point(528, 312), new Point(530, 312), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(531, 292), new Point(530, 290), new Point(528, 287), new Point(523, 294), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(525, 307), new Point(525, 305), new Point(526, 303), new Point(527, 302), 1,
            Color.BLACK);
        drawArc(g, new Point(526, 308), new Point(525, 309), new Point(525, 312), new Point(527, 312), 1,
            Color.BLACK);
        g.drawLine(527, 312, 524, 318);
        drawArc(g, new Point(524, 318), new Point(521, 318), new Point(520, 313), new Point(520, 311), 1,
            Color.BLACK);
        g.drawLine(520, 311, 526, 308);
        g.drawLine(528, 314, 531, 319);
        drawArc(g, new Point(531, 319), new Point(529, 320), new Point(526, 320), new Point(525, 319), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(506, 365), new Point(506, 363), new Point(506, 358), new Point(505, 357), 1,
            Color.BLACK);
        g.drawLine(505, 357, 509, 352);
        drawArc(g, new Point(504, 358), new Point(504, 360), new Point(505, 365), new Point(504, 368), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(464, 381), new Point(465, 379), new Point(468, 375), new Point(468, 373), 1,
            Color.BLACK);
        g.drawLine(468, 373, 477, 373);
        drawArc(g, new Point(466, 373), new Point(465, 374), new Point(464, 378), new Point(461, 380), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(408, 354), new Point(410, 352), new Point(415, 349), new Point(419, 350), 1,
            Color.BLACK);
        g.drawLine(182, 225, 79, 225);
        drawArc(g, new Point(373, 256), new Point(373, 256), new Point(372, 258), new Point(374, 259), 1,
            Color.BLACK);
        drawArc(g, new Point(374, 259), new Point(380, 261), new Point(391, 268), new Point(389, 280), 1,
            Color.BLACK);
        drawArc(g, new Point(389, 280), new Point(389, 283), new Point(388, 290), new Point(383, 294), 1,
            Color.BLACK);
        ...
        drawArc(g, new Point(377, 274), new Point(380, 275), new Point(385, 281), new Point(377, 289), 1,
            Color.BLACK);
        g.drawLine(377, 289, 377, 274);
        g.drawLine(518, 355, 543, 355);
        drawArc(g, new Point(543, 355), new Point(546, 357), new Point(550, 360), new Point(543, 363), 1,
            Color.BLACK);
        ...
        buffer = floodFill(buffer, new Point(430, 354), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(427, 351), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(435, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(438, 360), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(443, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(505, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(499, 372), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(491, 378), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(489, 379), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(516, 356), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(409, 351), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(410, 350), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(407, 354), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(408, 352), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(411, 355), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(424, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(425, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(432, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(439, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(437, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(455, 374), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(465, 375), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(464, 378), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(466, 374), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(476, 377), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(492, 377), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(494, 376), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(496, 375), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(502, 370), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(510, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(512, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(353, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(372, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(369, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(357, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(331, 349), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(329, 350), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(328, 351), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(338, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(336, 357), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(363, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(356, 360), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(365, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(361, 372), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(363, 368), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(370, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(362, 369), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(371, 368), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(369, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(369, 372), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(351, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(359, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(357, 369), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(357, 370), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(348, 356), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(347, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(346, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(345, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(344, 362), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(342, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(347, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(349, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(353, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(352, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(513, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(514, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(517, 354), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(516, 343), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(517, 345), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(518, 346), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(520, 334), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(521, 335), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(523, 338), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(524, 339), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(526, 316), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(525, 318), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(520, 316), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(522, 310), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(522, 309), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(524, 308), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(532, 305), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(531, 307), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(529, 306), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(530, 306), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(532, 307), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(533, 305), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(534, 307), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(534, 306), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(537, 310), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(537, 312), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(538, 313), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(538, 315), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(524, 293), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(530, 295), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(531, 296), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(530, 298), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(532, 306), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(535, 310), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(533, 310), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(531, 312), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(537, 312), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(538, 312), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(541, 319), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(539, 321), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(540, 321), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(538, 319), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(539, 320), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(533, 311), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(267, 355), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(241, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(291, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(240, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(241, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(261, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(262, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(260, 351), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(255, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(260, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(273, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(284, 370), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(274, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(259, 351), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(241, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(241, 354), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(284, 370), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(267, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(255, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(286, 374), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(290, 373), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(292, 372), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(297, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(291, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(263, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(250, 354), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(257, 356), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(260, 362), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(277, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(284, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(297, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(253, 352), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(263, 360), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(267, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(253, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(283, 374), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(277, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(274, 369), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(275, 371), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(275, 370), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(252, 353), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(257, 357), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(258, 356), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(259, 355), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(256, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(258, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(257, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(257, 360), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(265, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(267, 358), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(262, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(264, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(266, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(268, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(269, 368), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(271, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(283, 374), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(288, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(283, 373), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(269, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(271, 368), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(273, 368), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(270, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(272, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(275, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(274, 361), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(271, 359), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(279, 364), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(277, 365), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(281, 363), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(286, 369), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(276, 366), MyColor.PLACEHOLDER, MyColor.BLACK);
        buffer = floodFill(buffer, new Point(275, 367), MyColor.PLACEHOLDER, MyColor.BLACK);
        ...
        buffer = floodFill(buffer, new Point(538, 318), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(536, 314), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(532, 309), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(528, 291), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(526, 299), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(523, 305), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(524, 313), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(528, 318), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(528, 327), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(524, 334), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(521, 343), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(516, 351), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(508, 361), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(500, 367), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(491, 373), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(481, 376), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(472, 377), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(460, 377), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(450, 373), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(442, 368), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(435, 363), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(429, 359), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(422, 354), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(414, 354), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(375, 369), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(366, 370), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(359, 368), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(355, 365), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(349, 362), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(343, 358), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(338, 354), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(331, 352), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(291, 369), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(280, 367), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(274, 366), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(267, 362), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(261, 356), MyColor.PLACEHOLDER, MyColor.OAKUM);
        buffer = floodFill(buffer, new Point(254, 354), MyColor.PLACEHOLDER, MyColor.OAKUM);
